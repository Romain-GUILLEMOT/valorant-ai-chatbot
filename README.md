...
Le pseudo local reste dans le prompt pour identifier les stats du joueur local. La reponse finale doit etre ecrite a la premiere personne, comme si le joueur local parlait lui-meme, et ne doit jamais cibler, mentionner, moquer ou contenir le pseudo local ni une variante type `Yota...`.
