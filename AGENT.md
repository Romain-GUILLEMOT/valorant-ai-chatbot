...
- `T+1`: prompt enemy tilt.
- `T+2`: prompt encouragement equipe.
- `T+3`: prompt GG defaite avec bonnes stats individuelles.
- `T+4`: reponse objectif/KAST a un teammate qui critique.
- `T+5`: message WTF random safe.
